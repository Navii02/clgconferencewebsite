  ...
  return (
    <div className="font-sans antialiased text-gray-900 bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&q=80&w=1920")',
        }}
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="mb-8">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-blue-200 mb-2 leading-tight">
                Information Communication & Intelligent Systems
              </h2>
              <h3 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
                NCICIS 2025
              </h3>
            </div>
            ...
            <p className="text-base text-blue-100 mb-8 leading-relaxed max-w-2xl">
              The premier academic conference bringing together researchers,
              educators, and industry professionals to advance the frontiers of
              ICIS technologies.
            </p>
            ...
            <div className="flex flex-wrap gap-3 mb-10 justify-center">
              {Object.entries(timeLeft).map(([unit, value]) => (
                <div
                  key={unit}
                  className="flex flex-col items-center bg-white/10 backdrop-blur-sm rounded-lg p-3 min-w-[70px] border border-white/10"
                >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block text-blue-600 font-medium mb-4 text-xs uppercase tracking-wider">
              About The Conference
            </span>
            ...
            {[
              {
                ...
                content:
                  "Exploring cutting-edge developments in Information Communication and Intelligent Systems through academic research and industry applications.",
              },
              {
                title: "Conference Dates",
                icon: <Calendar className="w-6 h-6 text-blue-600" />,
                content:
                  "21st & 22nd August 2025 - A two-day offline conference featuring keynote lectures, paper presentations, and technical workshops.",
              },
              {
                title: "Organized By",
                icon: <Award className="w-6 h-6 text-blue-600" />,
                content:
                  "Jointly organized by Indian Society for Technical Education (ISTE) and College of Engineering, Poonjar.",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section className="relative py-20 bg-gradient-to-r from-gray-800 to-gray-900 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-blue-200 mb-8 max-w-3xl mx-auto leading-relaxed text-sm">
            Organized by ISTE and College of Engineering, Poonjar, this
            conference brings together academia and industry to advance ICIS
            technologies.
          </p>
